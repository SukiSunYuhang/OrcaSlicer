...
_flutter.buildConfig = {"engineRevision":"42d3d75a56efe1a2e9902f52dc8006099c45d937","builds":[{"compileTarget":"dart2js","renderer":"canvaskit","mainJsPath":"main.d1bbdc245c811153.js"},{}]};
...
//   <script src="$FLUTTER_OVERLAY_JS"></script>       (pre-Flutter loading/error overlay)
//   <script src="$FLUTTER_BOOTSTRAP_JS" async></script>
// (both placeholders are rewritten by tool/hash_web_assets.py to the
// content-hashed flutter_overlay.<hash>.js / flutter_bootstrap.<hash>.js).
// =============================================================================
(function () {
